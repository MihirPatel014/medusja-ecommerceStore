...
async function getRegionMap(cacheId: string) {
  ...
  if (
    ...
    console.log("Middleware: Using key", PUBLISHABLE_API_KEY)
    try {
      ...
      console.error("Middleware: Failed to fetch regions:", error.message)
      if (error.cause) {
        console.error("Middleware: Fetch error cause:", error.cause)
      }
      // Return existing cache or empty map instead of throwing to prevent crashing the middleware
